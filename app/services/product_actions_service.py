...
PRODUCT_STAGE_ACTIONS: Dict[str, Dict[str, List[str]]] = {
    ...
    # ========================================
    '8426': {
        # Чек работы системы (другая)
        'DT1070_38:UC_70SK2H': [],
        # Выведена на MRR
        'DT1070_38:UC_B7P2X4': [],
        # Ждём действий клиента
        'DT1070_38:UC_ILDKHV': [],
        # Подключение поставщиков (другая) — Настройка (2230)
        'DT1070_38:UC_NZK4JJ': [
            "Приемка накладных",
            "Списание пива вручную",
            "Списание пива Автопивом (если есть ЧЗ)",
        ],
        # Чек работы системы — Работа с остатками (2222)
        'DT1070_38:UC_XRWEHG': [
            "Возвраты/перемещения",
            "Списание крепкого вручную",
            "Инвентаризация",
        ],
        # Не можем завершить — Сопоставление (2916)
        'DT1070_38:UC_9JH4GA': [],
        # Завершение внедрения — Торговый зал (2918)
        'DT1070_38:UC_REJAS2': [
            "Списание крепкого по данным с кассы",
        ],
        # Не можем завершить (краткая)
        'DT1070_38:3': [],
        # Пауза до вывода
        'DT1070_38:UC_IM0YI8': [],
    ...
    '8432': {
        ...
        # Выведена на MRR
        'DT1070_38:UC_B7P2X4': [],
        # Ждём действий клиента — Ждем ВСД (3340)
        'DT1070_38:UC_ILDKHV': [
            "Получение, гашение и возврат ВСД",
        ],
        # Подключение поставщиков (другая)
        'DT1070_38:UC_NZK4JJ': [],
        # Чек работы системы
        'DT1070_38:UC_XRWEHG': [],
        # Не можем завершить
        'DT1070_38:UC_9JH4GA': [],
        # Завершение внедрения — Обучение (2394)
        'DT1070_38:UC_REJAS2': [],
        # Не можем завершить (краткая)
        'DT1070_38:3': [],
        # Пауза до вывода — Пауза (2384)
        'DT1070_38:UC_IM0YI8': [],
        # Подключение поставщиков
        'DT1070_38:UC_JK4IJR': [],
        # Завершить (final)
    ...
    '8434': {
        ...
        # Ждём действий клиента
        'DT1070_38:UC_ILDKHV': [],
        # Подключение поставщиков (другая) — Настройка ГИС МТ (2282)
        'DT1070_38:UC_NZK4JJ': [
        ...
        # Чек работы системы
        'DT1070_38:UC_XRWEHG': [],
        # Не можем завершить — Плагин (2938)
        'DT1070_38:UC_9JH4GA': [
            "GTIN в чеке при послаблении",
        ],
        # Завершение внедрения — Обучение (2284)
        'DT1070_38:UC_REJAS2': [],
        # Не можем завершить (краткая) — Ждем чек (2914)
        'DT1070_38:3': [],
        # Пауза до вывода — Пауза (2382)
        'DT1070_38:UC_IM0YI8': [],
        # Подключение поставщиков
        'DT1070_38:UC_JK4IJR': [],
        # Завершить (final)
    ...
    '8428': {
        ...
        # Подключение поставщиков (другая)
        'DT1070_38:UC_NZK4JJ': [],
        # Чек работы системы — Разобрать ТВП (2602)
        'DT1070_38:UC_XRWEHG': [],
        # Не можем завершить
        'DT1070_38:UC_9JH4GA': [],
        # Завершение внедрения — Обучение (2390)
        'DT1070_38:UC_REJAS2': [],
        # Не можем завершить (краткая)
        'DT1070_38:3': [],
        # Пауза до вывода — Пауза (2378)
        'DT1070_38:UC_IM0YI8': [],
        # Подключение поставщиков — Подключение поставщиков (2242)
        'DT1070_38:UC_JK4IJR': [
    ...
    '8430': {
        ...
        # Подключение поставщиков (другая)
        'DT1070_38:UC_NZK4JJ': [],
        # Чек работы системы — Запрос поставщиков (2252)
        'DT1070_38:UC_XRWEHG': [],
        # Не можем завершить
        'DT1070_38:UC_9JH4GA': [],
        # Завершение внедрения — Обучение (2258)
        'DT1070_38:UC_REJAS2': [],
        # Не можем завершить (краткая) — Ждем УПД (2332)
        'DT1070_38:3': [],
        # Пауза до вывода — Пауза (2380)
        'DT1070_38:UC_IM0YI8': [],
        # Подключение поставщиков — Подключение поставщиков (2912)
        'DT1070_38:UC_JK4IJR': [
